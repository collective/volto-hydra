 ...
 *
 * Scope is PER-CONTENT: `blocks_layout` integrity and (with a schema) that every
 * block type is one the frontend knows. Cross-tree reference existence (does an
 * href target exist?) needs the whole tree and is a separate pass.
 */
