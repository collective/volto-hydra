/**
 * Shared reference-classification for content validation. One copy, used by both
 * the distribution validator (plone-content-validator.cjs, over data.json) and
 * the format-agnostic content validator (content-validator.mjs, over any content
 * object). CJS so the sync CJS validator can `require` it and the ESM one can
 * `import` it. Mirrors pretagov-site/validate-content.py's link logic.
 */
'use strict';
