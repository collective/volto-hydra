...
// Stand-ins for blobs a fixture declares but the repo does not carry (large
// binaries are gitignored on purpose). One second of black, 32x32 — a REAL mp4,
// so a browser can actually decode it rather than choking on an empty 200.
const PLACEHOLDER_BLOBS = {
  'video/mp4': Buffer.from(
    '',
    'base64',
  ),
};
...
app.get('*/@@download/*', (req, res) => {
  ...
  // The blob may be declared by the content object but absent from the repo —
  // docs/.gitignore deliberately excludes the demo video, for instance. Plone
  // would serve the file, so answering 404 here makes a fixture look broken when
  // it isn't; the same reasoning already gives images a placeholder SVG. Serve a
  // placeholder of the DECLARED content type instead, so a <video> has something
  // real to load.
  const declared = loadRawContentFromDisk(contentPath)?.[fieldName];
  if (declared?.['content-type']) {
    const placeholder = PLACEHOLDER_BLOBS[declared['content-type']];
    if (placeholder) {
      res.setHeader('Content-Type', declared['content-type']);
