...
import { PAGE_BLOCK_UID, isBlockReadonly, expandTemplates } from '@volto-hydra/hydra-js';
import {
...
/**
 * Simple UUID generator (same as hydra.js generateUUID).
 */
 ...
 * @param {Function} options.uuidGenerator - UUID generator function
