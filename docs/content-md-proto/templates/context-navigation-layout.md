...
<block type="slate" templateId="/templates/context-navigation-layout" templateInstanceId="context-navigation-layout-def-instance" slotId="default" data-json='{"value":[{"type":"p","children":[{"text":""}]}]}' />
