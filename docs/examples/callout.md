...
```{literalinclude} examples/react/CalloutBlock.jsx
:language: jsx
```

### Vue

```{literalinclude} examples/vue/CalloutBlock.vue
:language: vue
```

### Svelte

```{literalinclude} examples/svelte/CalloutBlock.svelte
:language: svelte
```

### Astro

```{literalinclude} examples/astro/CalloutBlock.astro
:language: astro
```
