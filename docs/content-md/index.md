...
blocks:
  ...
  - hero-subhead: slate
  - hero-cta: slate
  - why-hydra-heading: slate
  - why-hydra-tagline: slate
  - why-hydra-quadrant: image
  - why-hydra-grid: gridBlock
  - quickstart-heading: slate
  - quickstart-code: codeExample
  - 303984b4-693a-408f-83f7-5a88b243d7db: slider
  - fae599f3-e7d4-451b-a413-84355c796b7e: gridBlock
  - 0ab1a8f7-2d26-4933-800c-2f10474afe63: separator
  - e972541f-b114-494b-a51e-cc8b11c8207d: slate
  - 9567ae6d-191c-43f1-91cc-4288bbb98f88: slate
  - 0d0c0506-f9bb-48d8-af0a-1352d81b45de: slate
  - 2fac7e5d-affb-4a8e-969f-2fac4d08e0fd: slate
order:
  - templates
  - images
...
<region name="tabs" widget="object_list" repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" data='{"items":[{"@id":"tab-nuxt"},{"@id":"tab-nextjs"},{"@id":"tab-svelte"},{"@id":"tab-vanilla"},{"@id":"tab-astro"}]}'>
