...
<block type="image" uid="img-16" align="center" size="l" url="${src}" alt="${alt}">
...
<region name="tabs" widget="object_list" repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" data='{"items":[{"@id":"ce-21-text-3d139a"}]}'>
...
<block type="image" uid="img-23" url="/docs/images/parent-chain" align="center" size="l">
...
<block type="codeExample" uid="ce-27">

<region name="tabs" widget="object_list" repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" data='{"items":[{"@id":"ce-27-text-19ff8a"}]}'>
...
<block type="image" uid="img-30" url="/docs/images/children-list" align="center" size="l">
