...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-accordion-schema-javascript-105cd5"]}
### Schema
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-accordion-json-data-json-f4f899"]}
### JSON Block Data
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-accordion-rendering-jsx-951c40","ref-accordion-rendering-vue-e897ff","ref-accordion-rendering-svelte-a58cd5"]}
### React
