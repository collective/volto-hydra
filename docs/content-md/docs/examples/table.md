...
:::title{uid="fb451586-3dab-4b40-a5f8-f73056685165"}
:::
...
:::heading{uid="ff4fd61a-f5eb-4733-a883-816985c44348" alignment="left" heading="${text}" tag="h${level}"}
```fields
{
 "styles": {}
}
...
:::slateTable{uid="0d727fc0-71c0-4e2c-918a-35b726636569"}
```fields
{
 "styles": {},
 "table": {
...
:::heading{uid="7aafc602-902a-4d21-bf63-2e7c5c8d4839" alignment="left" heading="${text}" tag="h${level}"}
```fields
{
 "styles": {}
}
...
:::slateTable{uid="4a5779a4-fda5-431c-80e5-3c789375ce10"}
```fields
{
 "styles": {},
 "table": {
...
:::heading{uid="10566683-a8b2-4b47-b64b-b01ddf43c307" alignment="left" heading="${text}" tag="h${level}"}
```fields
{
 "styles": {
...
:::slateTable{uid="0b0891c8-812e-41ca-b572-b7851361025f"}
```fields
{
 "styles": {
  "backgroundColor": "grey"
...
:::heading{uid="aa800193-7bf4-4f54-9bb6-a6c5b4e02b81" alignment="left" heading="${text}" tag="h${level}"}
```fields
{
 "styles": {
  "backgroundColor": "grey"
...
:::slateTable{uid="4266731a-e721-4f2f-95de-c7c3e885677b"}
```fields
{
 "styles": {
  "backgroundColor": "grey"
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-table-schema-javascript-237d52"]}
### Schema
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-table-json-data-json-472dd4"]}
### JSON Block Data
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-table-rendering-jsx-ee1611","ref-table-rendering-vue-570ccb","ref-table-rendering-svelte-de27fc"]}
### React
