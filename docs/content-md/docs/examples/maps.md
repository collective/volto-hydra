...
:::title{uid="68370edd-bfe5-47fb-937e-16a19a3a92ad"}
:::
...
:::maps{uid="e36a9020-5e7e-4ef5-97f7-862c45fea81c" align="wide" title="Plone Conference 2024 Location"}
```fields
{
 "styles": {}
}
...
:::separator{uid="96789bf6-953b-4777-a022-0f4cd852be64"}
```fields
{
 "styles": {
  "align": "full"
...
:::slate{uid="ce3be1bc-5e35-409d-971b-194bb084db4a"}
```fields
{
 "styles": {}
}
...
:::slate{uid="7248c659-f678-4e2f-8ac7-5bc5a8abf729"}
```fields
{
 "styles": {}
}
...
:::maps{uid="bd950eb2-f462-4146-9d4a-3c8139abbb94" align="center" title="Ploneconf 2022 was in Namur, Belgium "}
```fields
{
 "styles": {}
}
...
:::separator{uid="d5fe5f6d-2a9b-4e65-b5bf-2faded6073b7"}
```fields
{
 "styles": {
  "align": "left"
...
:::slate{uid="b94908e2-0600-493a-8a92-0b8a23e2938b"}
```fields
{
 "styles": {}
}
...
:::maps{uid="6ce27ed7-7470-4f83-a418-31b2c23e7f50" align="right" title="Ploneconf 2023 was in Eibar, Basque Country"}
```fields
{
 "styles": {}
}
...
:::slate{uid="0e3611aa-3dfe-421b-a8dc-c45ec3cf7262"}
```fields
{
 "styles": {}
}
...
:::maps{uid="642c75ac-0c4a-4138-8ad7-954a3fa561e6" align="left" title="Ploneconf 2018 was in Tokyo, Japan" url="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d205767.4968598755!2d139.73212733058264!3d35.74059553032941!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sde!2sde!4v1710240866243!5m2!1sde!2sde"}
```fields
{
 "styles": {}
}
...
:::slate{uid="aaf7adb1-00b2-4cc2-8729-91c33ea8fe6a"}
```fields
{
 "styles": {}
}
...
:::slate{uid="43a4b392-f0c3-4b8d-a17d-9b4ddea3f0f0"}
```fields
{
 "styles": {}
}
...
:::maps{uid="ceee1cfa-80ff-44f1-b3af-3cfd4be3f4ba" align="full" title="Ploneconf 2019 was in Ferrara, Italy"}
```fields
{
 "styles": {}
}
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-maps-schema-javascript-45f9f0"]}
### Schema
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-maps-json-data-json-04466f"]}
### JSON Block Data
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-maps-rendering-jsx-7fbc14","ref-maps-rendering-vue-85ab6d","ref-maps-rendering-svelte-4d9083"]}
### React
