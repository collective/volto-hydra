...
:::codeExample{uid="ref-contextNavigation-schema" templateId="/templates/block-reference-layout" templateInstanceId="tpl-inst-contextNavigation" slotId="schema" tabs="${1.../h3}" tabs.label="${1/text}" tabs.language="${2/lang}" tabs.code="${2/code}" tabs@ids=["ref-contextNavigation-schema-javascript-38f58f"]}
### Schema
...
:::codeExample{uid="ref-contextNavigation-json-data" templateId="/templates/block-reference-layout" templateInstanceId="tpl-inst-contextNavigation" slotId="json-data" tabs="${1.../h3}" tabs.label="${1/text}" tabs.language="${2/lang}" tabs.code="${2/code}" tabs@ids=["ref-contextNavigation-json-data-json-62b3b4"]}
### JSON Block Data
...
:::codeExample{uid="ref-contextNavigation-rendering" templateId="/templates/block-reference-layout" templateInstanceId="tpl-inst-contextNavigation" slotId="rendering" tabs="${1.../h3}" tabs.label="${1/text}" tabs.language="${2/lang}" tabs.code="${2/code}" tabs@ids=["ref-contextNavigation-rendering-jsx-25968a","ref-contextNavigation-rendering-vue-af752b","ref-contextNavigation-rendering-svelte-a27836"]}
### React
