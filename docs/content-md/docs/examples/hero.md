...
::::tabs[]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-hero-schema-javascript-698e6b"]}
### Schema
...
::::tabs[]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-hero-json-data-json-fc17f8"]}
### JSON Block Data
...
::::tabs[]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ref-hero-rendering-jsx-46a2e5","ref-hero-rendering-vue-337205","ref-hero-rendering-svelte-a2ecf7"]}
### React
