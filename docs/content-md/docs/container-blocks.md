...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-8-javascript-d2f77e"]}
### Javascript
  ...
  "children": [
   {
    ...
    "children": [
     {
      "text": "The region name is a key inside "
     },
     {
      "type": "code",
      "children": [
   ...
   {
    "text": " (a plain array of ids). A tempting mistake is to store it as a top-level field named after the region:  "
   },
   {
    "text": "<!-- codeExample: json -->"
   },
   {
    "text": " "
   },
   {
    ...
    "children": [
     {
      "text": "json // ✅ CORRECT — ordering keyed inside the shared blocks_layout dict { \"@type\": \"slider\", \"blocks\": { … }, \"blocks_layout\": { \"slides\": [\"slide-1\", \"slide-2\"] } }  // ❌ WRONG — an ad-hoc top-level `slides` field holding { items: [...] } { \"@type\": \"slider\", \"blocks\": { … }, \"slides\": { \"items\": [\"slide-1\", \"slide-2\"] } } "
     }
    ]
   },
   {
    "text": "  The wrong form may "
   },
   {
    "type": "em",
    "children": [
   ...
   {
    "text": " fine in a frontend that reads it back the same way, but "
   },
   {
    "type": "code",
    "children": [
   ...
   },
   {
    ...
    "children": [
     {
      "text": "silently drops it on save"
     }
    ]
   },
   {
   ...
   },
   {
    "type": "link",
    "data": {
     "url": "#why-these-persist-and-separate-top-level-fields-dont"
    },
    "children": [
     {
      "text": "Why these persist"
     }
    ]
   },
   {
    "text": ") — and tools that walk the shared dict (the block path map, the sanity checks, the editor's reorder/drag) never see the region, because they look under "
   },
   {
    "type": "code",
    "children": [
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-14-javascript-3ea062"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-21-javascript-83a0dc"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-24-javascript-6781ed"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-29-javascript-dd9f7e"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-31-javascript-f90eb4"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-41-javascript-85a3e1"]}
### Html
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-45-javascript-1cff8e"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-53-javascript-f4d972"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-62-javascript-4ebff8"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-68-javascript-cdad0c"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-72-javascript-521655"]}
### Javascript
...
::::tabs[object_list]{repeat="h3" label="${1/text}" language="${2/lang}" code="${2/code}" @ids=["ce-76-javascript-6b52c5"]}
### Javascript
  ...
  "children": [
   {
    ...
    "children": [
     ...
     {
      "text": " — schemaEnhancer recipe; surfaces parent-claimed fields on the parent and hides them on children."
     }
    ]
   },
   {
    ...
    "children": [
     ...
     {
      "text": " field; names the sibling field whose value drives every child's "
     },
     {
      "type": "code",
      "children": [
   ...
   },
   {
    ...
    "children": [
     ...
     {
      "text": " — names the sibling field directly on "
     },
     {
      "type": "code",
      "children": [
     ...
     {
      "text": ". Use this when there is no blocks field to declare "
     },
     {
      "type": "code",
      "children": [
   ...
   },
   {
    ...
    "children": [
     ...
     {
      "text": " — name of the field where a per-block "
     },
     {
      "type": "code",
      "children": [
     ...
     {
      "text": " override is stored. Required for the "
     },
     {
      "type": "code",
      "children": [
   ...
   },
   {
    ...
    "children": [
     ...
     },
     {
      ...
      "children": [
       {
        "text": "{ childType: [fieldName, ...] }"
       }
      ]
     },
     {
      "text": " per-child-type override. Replaces the "
     },
     {
      "type": "code",
      "children": [
   ...
   },
   {
    ...
    "children": [
     ...
     {
      "text": " — prefix for the inherited fields on the parent's \"Item Defaults\" fieldset (default: "
     },
     {
      "type": "code",
      "children": [
      ...
      "children": [
       {
        ...
        "children": [
         ...
         {
          "text": " to use for the choices. Auto-discovers if omitted. Set to "
         },
         {
          "type": "code",
          "children": [
         ...
         {
          "text": " when the choices should come from the "
         },
         {
          "type": "em",
          "children": [
           {
            "text": "enclosing parent's"
           }
          ]
         },
         {
       ...
       },
       {
        ...
        "children": [
         ...
         {
          "text": " accept the named source. Typically "
         },
         {
          "type": "code",
          "children": [
         ...
         {
          "text": " for listings (every item type must be populatable from canonical content fields)."
         }
        ]
       }
      ]
